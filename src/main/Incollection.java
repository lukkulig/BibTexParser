...
/**
 * Klasa bedaca obiektowa postacia deklaracji @Incollection zczytanej przez {@link Parser} 
 * 
 * @author Festus
 *
 */
public class Incollection extends Publication {
	...
	public String toString(char c) {
		...
		result += line
				...
				+ line
				+ String.format(format, c,"booktitle",c,booktitle,c)
				+ line
				+ String.format(format, c,"publisher",c,publisher,c)
				+ line
		...
		for(Map.Entry<String,String> entry : optionalFields.entrySet()) {
			if(!entry.getKey().equals("editor")){
				...
				String[] edit = entry.getValue().split(" and ");
