...
/**
 * Klasa bedaca obiektowa postacia deklaracji @Techreport zczytanej przez {@link Parser} 
 * 
 * @author Festus
 *
 */
public class Techreport extends Publication {
	...
	public String toString(char c) {
		...
		result += line
				...
				+ line
				+ String.format(format, c,"institution",c,institution,c)
				+ line
